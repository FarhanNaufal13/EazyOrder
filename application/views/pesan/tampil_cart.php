...
<tr id= "main_heading">
<td width="1%" scope="col" >No</td>
<td width="1%">Gambar</td>
<td width="1%">Item</td>
<td width="1%">Harga</td>
<td width="1%">Qty</td>
...
<tr>
<td><?php echo $i++; ?></td>
<td><img class="img-responsive" src="<?php echo base_url() . 'assets3/image/'.$item['gambar']; ?>"/></td>
...
<td><a href="<?php echo base_url()?>menuguest/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
<?php endforeach; ?>
</tr>
<tr>
...
<a href="<?php echo base_url()?>menuguest/cetak"  class ='btn btn-sm btn-primary'><i class="fa fa-print"></i>Print</a>
</tr>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
      	<form method="post" action="<?php echo base_url()?>menuguest/hapus/all">
